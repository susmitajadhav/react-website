  ...
  return (
    <div>
      ...
      <div className="industrial-panel-container">
        <h1 className="fade-in">Industrial Panel Manufacturer</h1>
        ...
        <div className="image-section">
          <img
            ...
            className="industrial-panel-image zoom-in"
          />
        </div>

        <h2 className="fade-in">Our Specializations:</h2>
        ...
        <h3 className="fade-in">Key Features & Benefits:</h3>
        ...
        <h4 className="fade-in">Applications:</h4>
        ...
        <p className="contact-info slide-up">
